...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' blob: https://apis.google.com https://*.googleapis.com https://*.google.com https://ai.google.dev https://*.stripe.com https://elevenlabs.io https://*.elevenlabs.io *.replit.dev *.repl.co; " +
